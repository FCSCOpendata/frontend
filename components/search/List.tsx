...
const List: React.FC<{ variables: any; setQvariables: any }> = ({
  ...
  return (
    <div>
      <div className="p-4">
        <div className="text-left text-4xl font-bold px-2 mb-4">
          {searchResults.count}{' '}
        ...
        <ul className="mb-10">
          {searchResults.results.map((dataset, index) => (
            <li
              key={index}
              className="flex justify-center sm:justify-start flex-wrap sm:flex-nowrap p-4"
            >
              ...
              <div className="ml-6 flex flex-col">
                ...
                <div className="flex flex-col sm:flex-row mt-2 space-x-3.5">
                  <div className="bg-red-100 px-2 py-0.5 rounded-2xl mb-1">
                    <svg
                      width="11"
                      height="9"
                      viewBox="0 0 11 9"
