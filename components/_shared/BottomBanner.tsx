export default function BottomBanner() {
  return (
    <div className="relative pb-32 pt-24">
      <div className="bg-red-50 p-20 rounded-2xl w-1/2">
        <span className="text-4xl font-semibold">
          Still not found <br /> what you&apos;re looking for ...?
        </span>
      </div>
      <div className="flex flex-col bg-black w-2/3 rounded-l-3xl px-24 py-20 absolute bottom-36 sm:bottom-24 -right-4">
